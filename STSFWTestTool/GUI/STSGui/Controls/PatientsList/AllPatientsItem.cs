...
namespace STSGui
{
    public partial class AllPatientsItem : UserControl
    {
        ...
        public AllPatientsItem()
        {
            InitializeComponent();
        }

        private void AllPatientsItem_Load(object sender, EventArgs e)
        {
            if (this.DesignMode)
                return;
        ...
        public static event Action<Patient> DeleteButtonClick;
        ...
        public void Reset()
        {
            ...
            ethnicityLabel.BackColor = Color.Transparent;
        }
        #endregion
        ...
        private void InitBitmapControls()
        {
            ...
            GuiUtils.SetNewLocation(genderLabel, itemBackgroundPictureBox);
            GuiUtils.SetNewLocation(ethnicityLabel, itemBackgroundPictureBox);
            ...
            this.Controls.Remove(genderLabel);
            this.Controls.Remove(ethnicityLabel);
            ...
            itemBackgroundPictureBox.Controls.Add(genderLabel);
            itemBackgroundPictureBox.Controls.Add(ethnicityLabel);
        ...
        private void TopLabelsSetForeColor(Color textColor)
        {
            ...
            genderLabel.ForeColor = textColor;
            ethnicityLabel.ForeColor = textColor;
        }
        ...
        private void InitPatient()
        {
            ...
            else
            {
                ...
                genderLabel.Text = currentPatient.Gender.ToString();
                ethnicityLabel.Text = $"{currentPatient.Ethnicity}";
        ...
        private void itemBackgroundPictureBox_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            if (currentPatient == null)
                return;
            DeleteButtonClick?.Invoke(currentPatient);
        }
    }
}
